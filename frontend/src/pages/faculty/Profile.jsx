      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 lg:p-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center mb-6 sm:mb-8">
            <div className="h-16 w-16 sm:h-20 sm:w-20 rounded-full bg-indigo-500 flex items-center justify-center mb-4 sm:mb-0 sm:mr-6 mx-auto sm:mx-0">
            ...
            <div className="text-center sm:text-left">
              ...
              <p className="text-base sm:text-lg text-gray-600 capitalize">{profile?.role}</p>
            </div>
          </div>
          ...
          <div className="mt-6 sm:mt-8 bg-green-50 border border-green-200 rounded-lg p-4 sm:p-6">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                ...
                <p className="text-xs sm:text-sm text-green-700">Your account is active and in good standing.</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 sm:mt-8 flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
            <button
              ...
              className="px-4 sm:px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors duration-200 text-sm sm:text-base"
            >
              Back to Dashboard
            </button>
            <button
