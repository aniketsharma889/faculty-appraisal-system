    ...
    <DashboardLayout allowedRole="hod">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          {successMessage && (
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-400 p-4 mb-6">
              <div className="flex items-center">
                <svg className="w-5 h-5 text-green-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                </svg>
                <span className="text-sm sm:text-base text-green-700 font-medium">{successMessage}</span>
              </div>
            </div>
          )}

          {/* Header Section */}
          <div className="bg-gradient-to-r from-green-600 to-emerald-600 px-4 sm:px-6 lg:px-8 py-8">
            <div className="flex flex-col sm:flex-row sm:items-center">
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="flex items-center justify-center sm:justify-start">
                  ...
                  <p className="text-base sm:text-lg text-green-100 font-medium">Head of Department</p>
                </div>
                {profile?.department && (
                  <p className="text-green-200 mt-1">{profile.department}</p>
                )}
              </div>
            </div>
          </div>
          ...
          <div className="p-4 sm:p-6 lg:p-8">
            ...
            <div className="mt-8 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-green-700 leading-relaxed">Your HOD account is active and authorized for department management. You have full access to faculty appraisal reviews and department oversight.</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row justify-center space-y-3 sm:space-y-0 sm:space-x-4">
              <button
                ...
                className="group px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center justify-center"
              >
              ...
              <button
                onClick={() => navigate(`/hod/edit-profile/${profile?.id}`)}
                className="group px-6 py-3 bg-white text-green-600 border-2 border-green-600 rounded-lg hover:bg-green-600 hover:text-white transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center justify-center"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
